...
port = 15344
password = 'JRGTEh9QfIDK2mR3oiUHdj1lSK2KeH64'
...
while True:
    ...
    plt.bar(list(combined_dict.keys())[0:5], list(combined_dict.values())[0:5])

    print(list(combined_dict.keys())[0:5])
    print(list(combined_dict.values())[0:5])
